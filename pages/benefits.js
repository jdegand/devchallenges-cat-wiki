...
export default function Benefits(){
    return (
        <main className={styles.main}>
            ...
            <p>A lot of these scientific studies probably have tons of flaws.  Selection bias is probably a big issue in pet ownership studies.  Are cat owners already happy and healthy people?  Obviously, owning a pet is a significant financial commitment as well.  If you choose to own a pet, you probably are financially secure and financial means improves health results.  Pet ownership satisfaction is obtained through surveys.  Obviously, people may feel guilty about admitting it was a mistake to get a pet.  I think a lot of these studies are probably run by the pet owners themselves seeking to validate their choice.  The satisfaction of owning a pet cannot also discount the grief that could follow with the pet's death.  Don't think owning a pet will magically fix your problems.  After a while, your happiness will regress to the your mean happiness. </p>
        </main>
    )
}